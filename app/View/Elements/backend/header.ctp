    ...
    <div class="headerwrapper">
        <div class="header-left">
            <a href="index.html" class="logo">
                <img src="<?php echo Configure::read('IMG_URL'); ?>logo.png" alt="" /> 
            </a>
                ...
                <div class="btn-group btn-group-list btn-group-notification">
                    ...
                    <div class="dropdown-menu pull-right">
                        ...
                        <ul class="media-list dropdown-list">
                            <li class="media">
                                <img class="img-circle pull-left noti-thumb" src="<?php echo Configure::read('IMG_URL_AVATAR'); ?>user1.png" alt="">
                            ...
                            <li class="media">
                                <img class="img-circle pull-left noti-thumb" src="<?php echo Configure::read('IMG_URL_AVATAR'); ?>user2.png" alt="">
                                <div class="media-body">
                            ...
                            <li class="media">
                                <img class="img-circle pull-left noti-thumb" src="<?php echo Configure::read('IMG_URL_AVATAR'); ?>user3.png" alt="">
                                <div class="media-body">
                            ...
                            <li class="media">
                                <img class="img-circle pull-left noti-thumb" src="<?php echo Configure::read('IMG_URL_AVATAR'); ?>user4.png" alt="">
                                <div class="media-body">
